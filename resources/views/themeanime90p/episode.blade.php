...
@push('scripts')
    <script src="/themes/anime90p/player/js/p2p-media-loader-core.min.js"></script>
    <script src="/themes/anime90p/player/js/p2p-media-loader-hlsjs.min.js"></script>
            ...
            if (type == 'embed') {
                if (vastAds) {
                    ...
                    const objSetupFake = {
                        ...
                        width: "100%",
                        height: "100%",
                        file: "/themes/anime90p/player/1s_blank.mp4",
                        volume: 100,
                        mute: false,
                        autostart: true,
                        advertising: {
    ...
    <script type="text/javascript" src="/themes/anime90p/js/watch.js"></script>
